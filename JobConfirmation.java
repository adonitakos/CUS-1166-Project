...
class JobConfirmation extends JFrame implements ActionListener {
        ...
        private JLabel thankYouLabel, jobCompletionLabel, jobIDLabel, jobDeadlineLabel, jobDurationLabel,
                        jobDescriptionLabel;
        ...
        JobConfirmation(Job job) {
                ...
                // JobID Label
                jobIDLabel = new JLabel("<html><b><u>Job ID:</u></b> " + job.getJobID() + "</html>",
                ...
                jobDurationLabel = new JLabel(
                                "<html><b><u>Job Duration:</b></u> " + job.getJobDuration() + " hours.</html>",
                                SwingConstants.CENTER);
                ...
                // Job Deadline Label
                jobDeadlineLabel = new JLabel("<html><b><u>Job Deadline:</b></u> " + job.getJobDeadline() + "</html>",
                                SwingConstants.CENTER);
                ...
                jobDescriptionLabel = new JLabel(
                                "<html><b><u>Job Description:</b></u> " + job.getJobDescription() + "</html>",
                                SwingConstants.CENTER);
                ...
                jobCompletionLabel = new JLabel(
                                "<html><b><u>Job Completion Time:</b></u> " + job.getCompletionTime()
                                                + " hours.</html>",
                                SwingConstants.CENTER);
