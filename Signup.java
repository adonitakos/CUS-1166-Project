...
class CreateSignupForm extends JFrame implements ActionListener {
    ...
    CreateSignupForm() {
        ...
        infoLabel.setText(
                "<html><center>Thanks for choosing Vehicle Vortex! To sign up, please enter your desired username and password. Each field must be at least 5 characters long, and your password must contain at least one special character.</center></html>");
