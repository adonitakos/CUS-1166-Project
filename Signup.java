...
class CreateSignupForm extends JFrame implements ActionListener {
    ...
    CreateSignupForm() throws IOException {
        ...
        infoLabel.setText(
                "<html><center>Thanks for choosing Vehicle Vortex! To sign up, please enter your desired username and password."
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (obj == submit) {
            ...
            // writer.write("Username: " + userValue + " | Password: " + passValue + " |
            // Timestamp: "
